...
define([], function() {
	...
	ChallengeData.CHALLENGE_BG = 			[4, 2, 0, 7, 5, 11];
	...
	ChallengeData.CHALLENGE_PROG = 			[0, 0, 1, 2, 3, 3];
	ChallengeData.ANGLE = 					[0, 0, 0, 0, 1, 0];
	...
	ChallengeData.CHALLENGE_START_POS = 	[{'x':0.8, 'y':0.1}, {'x':0.8, 'y':0.2}, {'x':0.2, 'y':0.9}, {'x':0.05, 'y':0.8}, {'x':0.2, 'y':0.1}, {'x':0.5, 'y':0.5}];
