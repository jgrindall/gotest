...
function($, PhaserComponents){
	...
	var NameView = function(model){
		var onChange;
		this.el = $("<input id='name' maxlength='24' type='text'></input>");
		this.model = model;
