...
define(['base/consts/commandpaneltypes',

'base/views/commandpanels/nsewcommandspanel',

'base/views/commandpanels/nsewkeyscommandspanel',

'base/views/commandpanels/nsew45keyscommandspanel',

'base/views/commandpanels/nsturnkeyscommandspanel',

'base/prog/progcommandpanel', 'base/consts/progtypes',

'base/views/commandpanels/markers/markertypes',

'base/prog/targets/targetfactory',
...
TargetFactory
	...
	CommandsPanelFactory.makeHitzones = function(num, double){
		...
		for(i = 1; i <= num; i++){
			h = [];
			if(double){
				h.push({"accept":[0], "bounds":{'x':-15, 'y':0}});
				h.push({"accept":[1], "bounds":{'x':14, 'y':0}});
			}
			else{
