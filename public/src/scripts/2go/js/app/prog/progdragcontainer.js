define(
	...
	['phasercomponents', 'base/consts/commandpaneltypes',

	'base/views/buttons/clearbutton', 'base/logocommands/commandtypes',

	'base/views/buttons/playbutton', 'base/views/buttons/stopbutton',

	'base/events/events', 'base/consts/playingstate',

	'base/prog/controller/progcontrollerfactory',
